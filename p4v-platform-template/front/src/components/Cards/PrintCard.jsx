...
import {
    ...
    territory_title,
    territory_title_instrumental, website_name, website_url_p4v
                ...
                <React.Fragment>
                    <div className="print-card">
                        ...
                        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Перевірити заборгованість можна у застосунках &laquo;{website_name}&raquo;
                            <a href={website_url_p4v} target={"_blank"}>{website_url_p4v}</a> та чат - бот в Telegram &laquo;{telegram_name}&raquo; <a href={telegram_url} target={"_blank"}>{telegram_url}</a>, які надають
